 ...
 *
 * Class P except `createSurfaceMaterialArrays`, the single GPU boundary.
 * This is the same shape `FoliageAtlas` (`2-11`) and `ImpostorAtlas` (`2-17`)
 * already ship, and the reason for it is that assertions 53, 54 and 55 are
 * then ordinary Node tests over the plan rather than GPU readbacks.
 *
...
/**
 * The pure half of `createSurfaceMaterialArrays`. Array A reduces through the
